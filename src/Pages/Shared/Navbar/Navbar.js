...
const Navbar = () => {
  ...
  return (
    <div
      className={` w-full z-10 top-0 left-0 ${
        fix
          ? "fixed top-0 z-10 transition-all duration-300 ease-in-out navglassmorphism "
          : "relative"
      } `}
    >
      ...
      <div className={`${styles.boxWidth} mx-auto sm:px-10 xs:px-5 px-0 `}>
        <div className="flex justify-between py-4 ">
          ...
          >
            ...
            <li>
              <Link className="lg:ml-8 ml-0" to="/documentation">
                Documentation
              </Link>
            </li>
            <li>
            ...
            <li>
              <Link className="lg:ml-8 ml-0" to="/login">
                Login
              </Link>
            </li>
            <li>
              <Link className="lg:ml-8 ml-0" to="/signup">
                Sign Up
              </Link>
            </li>
          </ul>
